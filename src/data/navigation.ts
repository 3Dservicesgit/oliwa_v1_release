...
export const DEFAULT_NAV_ITEMS: NavRailItem[] = [
  ...
  { key: "events",            glyph: "⚡", label: "Events & Notifications", path: "/events"           },
  { key: "sim",               glyph: "🪙", label: "Token Subscription",   path: "/sim"               },
...
export const DEFAULT_SIDEBAR_ITEMS: SidebarItem[] = [
  ...
  { key: "events",            label: "Events & Notifications",  path: "/events"            },
  { key: "sim",               label: "Token Subscription",      path: "/sim"               },
